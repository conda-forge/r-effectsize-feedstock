...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-effectsize-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8460&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-effectsize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-effectsize` can be installed with:

```
conda install r-effectsize
```

It is possible to list all of the versions of `r-effectsize` available on your platform with:
